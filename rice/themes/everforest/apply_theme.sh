...
cp ~/.config/rice/themes/everforest/hyprland/color.conf ~/.config/hypr/color.conf
cp ~/.config/rice/themes/everforest/rofi/current.rasi ~/.config/rofi/current.rasi
cp ~/.config/rice/themes/everforest/quickshell/current.qml ~/.config/quickshell/color/current.qml
